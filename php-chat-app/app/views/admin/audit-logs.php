...
?>
            <div class="admin-page-head">
                <div>
                    ...
                    <h1>Audit logs</h1>
                    <p>Review recent admin actions and moderation changes.</p>
                </div>
                <a class="auth-button button-reset admin-primary-action" href="<?= htmlspecialchars(url('/admin/audit-logs/export'), ENT_QUOTES, 'UTF-8'); ?>">Export CSV</a>
            </div>
