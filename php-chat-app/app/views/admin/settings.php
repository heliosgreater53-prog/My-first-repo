...
?>
            <div class="admin-page-head">
                <div>
                    ...
                    <h1>Settings</h1>
                    <p>Flagged words, signup invites, and mail status.</p>
                </div>
            </div>
            ...
            <section class="admin-panel">
                ...
                <form class="admin-create-form" method="POST" action="<?= htmlspecialchars(url('/admin/invites/create'), ENT_QUOTES, 'UTF-8'); ?>">
                    <?= csrf_input(); ?>
