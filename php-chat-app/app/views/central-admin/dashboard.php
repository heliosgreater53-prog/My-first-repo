...
?>
            <div class="admin-page-head">
                <div>
                    <span class="admin-kicker">Central admin overview</span>
                    <h1>Central admin dashboard</h1>
                    <p>Monitor the whole platform, manage rooms and accounts, and respond to flagged activity.</p>
                </div>
                <a class="auth-button button-reset admin-primary-action" href="<?= htmlspecialchars(url('/central-admin/rooms'), ENT_QUOTES, 'UTF-8'); ?>"><i class="bi bi-door-open"></i> Manage rooms</a>
            </div>
            ...
            <section class="admin-panel">
                ...
                <form class="admin-broadcast-form" method="POST" action="<?= htmlspecialchars(url('/central-admin/broadcast'), ENT_QUOTES, 'UTF-8'); ?>">
                    <?= csrf_input(); ?>
                    <div class="field">
            ...
            <div class="admin-two-column">
                <section class="admin-panel">
                    <div class="admin-panel-head">
                        <div>
                            ...
                            <p>Latest messages across the platform.</p>
                        </div>
                ...
                <section class="admin-panel">
                    <div class="admin-panel-head">
                        <div>
                            <h2>Rooms</h2>
                            <p>Current conversation spaces in the app.</p>
                        </div>
                        <a class="admin-text-link" href="<?= htmlspecialchars(url('/central-admin/rooms'), ENT_QUOTES, 'UTF-8'); ?>">Manage all</a>
                    </div>
